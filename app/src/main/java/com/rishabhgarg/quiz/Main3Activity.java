...
public class Main3Activity extends AppCompatActivity {
    ...
    CountDownTimer cdt;
    int score=0;
    String ans[]={"0","Final","Both static and final","objects","Constructor"};
    ...
    public void onclick(View v) {
        ...
        if(rdbtid==-1){
            Toast.makeText(Main3Activity.this,"Please choose any",Toast.LENGTH_SHORT).show();
            cdt.cancel();
            finish();
            return;
        }else {
    ...
    public void result(){
        ...
        Toast.makeText(Main3Activity.this,"Your Result is "+Integer.toString(score)+"/5",Toast.LENGTH_SHORT).show();
        cdt.cancel();
        finish();
    }
    @Override
