...
public class Main4Activity extends AppCompatActivity {
    ...
    CountDownTimer cdt;
    int score=0;
    String ans[]={"largest railway station","1914","Mica","25","Methane"};
    ...
    public void onclick(View v) {
        ...
        if(rdbtid==-1){
            Toast.makeText(Main4Activity.this,"Please choose any",Toast.LENGTH_SHORT).show();
            cdt.cancel();
            finish();
            return;
        }else {
    ...
    public void result(){
        ...
        Toast.makeText(Main4Activity.this,"Your Result is "+Integer.toString(score)+"/5",Toast.LENGTH_SHORT).show();
        cdt.cancel();
        finish();
    }
